...
export default function Quiz() {
  ...
  // If the user navigates away before submitting, close the session so it
  // isn't left dangling with ended_at NULL forever. submit() already nulls
  // sessionRef when it ends the session normally, so this is a no-op then.
  useEffect(() => {
    return () => {
