...
async def upload_note(
    ...
    # Cap extracted text to defend against decompression-bomb style files where
    # a small PDF/DOCX expands into many MB of text. 1 MB ~ 250k tokens of
    # English, more than enough for any reasonable lecture note.
