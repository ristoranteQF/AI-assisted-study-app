...
def confirm_email_change(
    ...
    # Reject the token if the user has since requested a different change
    # (or cancelled the pending one entirely). Prevents replay of a stale link.
    ...
    # Last-second uniqueness re-check — another user may have claimed the
    # address between the request and confirmation.
    clash = db.scalar(
